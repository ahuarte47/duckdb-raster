...
| Function | Summary |
| --- | --- |
| [`RT_RasterValue`](docs/functions.md#rt_rastervalue) | Returns the value in a datacube or filepath at the specified pixel coordinates. |
| [`RT_RasterValues`](docs/functions.md#rt_rastervalues) | Returns the values in a band of a datacube or filepath at the specified array of pixel coordinates. |
| [`RT_CoordValue`](docs/functions.md#rt_coordvalue) | Returns the value in a datacube or filepath at the specified world coordinates. |
| [`RT_CoordValues`](docs/functions.md#rt_coordvalues) | Returns the values in a band of a datacube or filepath at the specified array of world coordinates. |
